...
def test_architecture_audit_reports_two_agent_shape_and_migration_warning() -> None:
    ...
    assert_true("explicit_legacy_handler_surface_contracts", checks["explicit_legacy_handler_surface_contracts"]["status"] == "pass", str(checks["explicit_legacy_handler_surface_contracts"]))
