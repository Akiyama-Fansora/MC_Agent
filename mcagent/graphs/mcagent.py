...
def build_mcagent_graph(config: AppConfig, legacy_delivery: LegacyDeliveryFn, emit: EmitFn | None = None):
    ...
    def receive(state: AgentGraphState) -> dict[str, Any]:
        ...
        return {
            ...
            "tool_boundary": {
                ...
                "principle": "MCagent answers only from local资料/RAG and may request CrawlerAgent through AgentMessage when local evidence is insufficient.",
            },
    ...
    builder.add_edge("load_memory_boundary", "legacy_runtime")
