...
MIGRATED_GRAPH_HANDLER_SURFACES = {"status", "crawler_audit", "local_corpus_inventory", "router_error", "direct_answer"}
    ...
    *,
    ...
    return {
        ...
        "objective_contract": (
            ...
            "judge evidence, or alter routing. Migrated status, crawler_audit, router_error, direct_answer, and safe local_corpus_inventory "
