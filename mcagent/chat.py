...
12a. 对整合包的 Minecraft 版本、加载器、Forge/Fabric/NeoForge 版本等强事实，必须优先采用 manifest.json 的 minecraft.version 与 minecraft.modLoaders 字段；不要从压缩包文件名、Release 编号或 FIX 编号推断 Minecraft 版本。
