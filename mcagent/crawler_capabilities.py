...
CAPABILITIES: dict[str, CrawlerCapability] = {
    ...
    "playwright": CrawlerCapability(
        ...
        group="group:browser",
        profile="research",
        purpose="Render/search pages with a local browser using Playwright MCP-style snapshots: page text, interactive element refs, raw HTML, screenshot, console, and network evidence.",
